...
public final class SuperPet implements Model {
  ...
  private SuperPet(String id, String name, SuperPetTypeEnum type, Temporal.DateTime birthDate, Integer height, SuperOwner superOwner, String s3ImageKey) {
    this.id = id;
    this.name = name;
    this.type = type;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, SuperPetTypeEnum type, Temporal.DateTime birthDate, Integer height, SuperOwner superOwner, String s3ImageKey) {
      super.id(id);
      super.name(name)
        .type(type)
        .birthDate(birthDate)
